let inquirer;_0f9‍.w("inquirer",[["default",["inquirer"],function(v){inquirer=v}]]);const mongoose = require('mongoose')
...
exports.reset = async function () {
    ...
    try {
        ...
        _0f9‍.g.console.log(chalk.green.bold("\nThe database reset successfully\n"))
        return true
    } catch (err) {
        _0f9‍.g.console.error(err)
    } finally {
        spinner.stop()
    }
}
