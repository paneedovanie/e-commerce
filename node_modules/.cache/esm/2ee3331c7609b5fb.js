let inquirer;_760‍.w("inquirer",[["default",["inquirer"],function(v){inquirer=v}]]);const mongoose = require('mongoose')
...
exports.reset = async function () {
    ...
    try {
        ...
        _760‍.g.console.log(chalk.green.bold("\nThe database reset successfully\n"))
        return true
    } catch (err) { _760‍.g.console.error(err) } 
    finally {
        spinner.stop()
    }
}
