let inquirer;_db4‍.w("inquirer",[["default",["inquirer"],function(v){inquirer=v}]]);const mongoose = require('mongoose')
const fs = require('fs')
...
exports.reset = async function () {
    ...
    try {
        ...
        _db4‍.g.console.log(chalk.green.bold("\nThe database reset successfully\n"))
        return true
    } catch (err) {
        _db4‍.g.console.error(err)
    } finally {
        spinner.stop()
    }
}
