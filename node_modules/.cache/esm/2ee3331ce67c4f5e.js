let inquirer;_e67‍.w("inquirer",[["default",["inquirer"],function(v){inquirer=v}]]);const mongoose = require('mongoose')
...
exports.reset = async function () {
    ...
    try {
        ...
        _e67‍.g.console.log(chalk.green.bold("\nThe database reset successfully\n"))
        return true
    } catch (err) { _e67‍.g.console.error(err) } 
    finally {
        spinner.stop()
    }
}
